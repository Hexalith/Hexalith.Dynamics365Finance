...
namespace Hexalith.Dynamics365Finance.Parties.Customers.Helpers;
...
public static class CustomerConverterHelper
{
    ...
    /// <returns>Hexalith.Dynamics365Finance.Parties.Customers.Entities.CustomerV3Create.</returns>
