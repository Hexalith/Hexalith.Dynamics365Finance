...
namespace Hexalith.Dynamics365Finance.Inventories.PartnerInventoryItems.BusinessEvents;
...
{
    /// <inheritdoc/>
    public override string AggregateId => InventoryHelper.GetPartnerInventoryItemAggregateId(
    ...
    /// <inheritdoc/>
    public override string AggregateName => InventoryHelper.PartnerInventoryItemAggregateName;
